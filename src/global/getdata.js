import { getObjType,rgbTohex,generateRandomId } from '../utils/util';
...
export function datagridgrowth(data, addr, addc, iscallback) {
    ...
    for (let r = 0; r < addr; r++) {
        ...
        for (let c = 0; c < coladd.length; c++) {
            data[r][c]={id:generateRandomId('cell')};
        }
    }
   
        console.log("🚀 ~ datagridgrowth ~ data:", data[0][0])
